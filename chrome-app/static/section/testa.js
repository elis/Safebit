r sectionFunds = (function() {
	...
	function prepareSendForm () {
		...
		var art = $('.send-funds', $section),
			$details = $('.txdetails', art),
			$fromInput = $('.account input', art),
			$targetInput = $('.target input', art),
			$amountInput = $('.amount input', art),
			$confirmButton = $('.actions .confirm', art);
			...
			if (tempAccounts[val]) {
				...
				if (amount) {
					if (amount > account.amount) {
						from = false;
						$('.amount input', art).addClass('error').removeClass('good');
						$el.addClass('error').removeClass('good');
					} else {
						$('.amount input', art).removeClass('error').addClass('good');
			...
			.bind('keyup', function (event) {
				...
				$ptx.dialog('open');
					...
					if (account) {
						...
						safebitui.baseCall('sendfrom', function(result) {
							if (result) {
